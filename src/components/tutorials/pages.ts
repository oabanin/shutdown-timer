import standardNavIcons from "@/components/tutorials/AppNavIcons";
...
export const materialPages = [
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            pathname: "/material-ui/react-css-baseline",
            title: "CSS Baseline",
          },
          { pathname: "/material-ui/react-modal" },
          {
            pathname: "/material-ui/react-no-ssr",
            title: "No SSR",
            deprecated: true,
          },
  ...
  },
  {
    ...
    children: [
      ...
      {
        pathname: "/material-ui/customization/right-to-left",
        title: "Right-to-left",
      },
      {
        pathname: "/material-ui/customization/shadow-dom",
        title: "Shadow DOM",
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          {
            pathname:
              "/material-ui/customization/css-theme-variables/configuration",
  ...
  },
  {
    ...
    children: [
      ...
      {
        pathname: "/material-ui/integrations/routing",
        title: "Routing libraries",
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        pathname: "/material-ui/experimental-api/pigment-css",
        title: "Pigment CSS",
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            pathname: "/material-ui/migration/migration-v3",
            title: "Migration from v3 to v4",
          },
          {
            pathname: "/material-ui/migration/migration-v0x",
            title: "Migration from v0.x to v1",
          },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        pathname: "/material-ui/discover-more/backers",
