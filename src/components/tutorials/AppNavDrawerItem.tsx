...
import { samePageLinkNavigation } from "@/components/tutorials/helpers";
...
export default function AppNavDrawerItem(props) {
  ...
  const hasIcon =
    icon && (typeof icon !== "string" || !!standardNavIcons[icon]);
  const IconComponent =
    typeof icon === "string" ? standardNavIcons[icon] : icon;
